...
/**
 * Integration tests for {@link OwnerLookupService} against the seeded clinic database.
 */
@SpringBootTest
class OwnerLookupServiceIntegrationTests extends OwnerLookupTestSupport {
	...
	void findAllReturnsTheSeededOwners() {
		...
		assertThat(found).extracting(Owner::getLastName).contains("Franklin", "Estaban");
	}
